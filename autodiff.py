...
class Node(object):
    ...
    def __eq__(self, other):
        # print(type(other))
        return isinstance(other, Node) and self.op == other.op and self.name == other.name
    ...
    def run(self, feed_dict):
        ...
        for node in topo_order:
            ...
            if (node.inputs):
                ...
                # print('node value mapping', node, node_to_val_map[node])
...
def gradients(output_node, node_list):
    ...
    # print(node_to_output_grad[node_list[0]])
